...
import { sendMessage, sendMessageWithInlineKeyboard, sendVideoByUrl } from "@/utils/telegram";
...
export default async function handler(req, res) {
  if (req.method == "POST") {
    ...
    if (text.startsWith("/start") || text.startsWith("/help")) {
      ...
      await sendMessageWithInlineKeyboard(chatId, text); //todo: test this send message with inline keyboard
    }
